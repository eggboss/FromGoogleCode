...
public class UserServiceServiceLocator extends org.apache.axis.client.Service implements kirk.ws.demo.UserServiceService {
    ...
    private java.lang.String UserService_address = "http://localhost:8080/WebServiceAxis/services/UserService";
    ...
    public kirk.ws.demo.UserService getUserService() throws javax.xml.rpc.ServiceException {
    ...
    public kirk.ws.demo.UserService getUserService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            kirk.ws.demo.UserServiceSoapBindingStub _stub = new kirk.ws.demo.UserServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (kirk.ws.demo.UserService.class.isAssignableFrom(serviceEndpointInterface)) {
                kirk.ws.demo.UserServiceSoapBindingStub _stub = new kirk.ws.demo.UserServiceSoapBindingStub(new java.net.URL(UserService_address), this);
                _stub.setPortName(getUserServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://demo.ws.kirk", "UserServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://demo.ws.kirk", "UserService"));
        }
