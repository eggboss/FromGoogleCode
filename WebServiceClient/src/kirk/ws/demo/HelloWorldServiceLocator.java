...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements kirk.ws.demo.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/WebServiceAxis/services/HelloWorld";
    ...
    public kirk.ws.demo.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public kirk.ws.demo.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            kirk.ws.demo.HelloWorldSoapBindingStub _stub = new kirk.ws.demo.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (kirk.ws.demo.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                kirk.ws.demo.HelloWorldSoapBindingStub _stub = new kirk.ws.demo.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://demo.ws.kirk", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://demo.ws.kirk", "HelloWorld"));
        }
